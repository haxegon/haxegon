Haxegon currently doesn't work with the up to date versions of openfl/lime (https://github.com/haxegon/haxegon/issues/332), but you can still use it with the following old versions of the library:
